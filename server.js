let vlInss;
    ...
    function executa() {
        ...
        document.getElementById('inss').innerHTML = vlInss.toFixed(2);
        document.getElementById('irrf').innerHTML = vlIrrf.toFixed(2);
        document.getElementById('bruto').innerHTML = sBase.toFixed(2);
        document.getElementById('liquido').innerHTML = sLiquido.toFixed(2);
    }